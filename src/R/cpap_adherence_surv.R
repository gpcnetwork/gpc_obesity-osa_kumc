...
for(adh in adh_metric){
  for(boot_i in boots_iter){
    ...
    if(!file.exists(path_to_file)){
      ...
      #----------------------------------
      print(paste0(adh,"...",boot_i,"...","IPTW model developed"))
      ...
      if(adh == 'cpap_yr1'){
        if(!file.exists(file.path(path_to_dir,"pspline_termplot.rda"))){
          ...
          #----------------------------------
          print(paste0(adh,"...",boot_i,"...","spline model extracted"))
    ...
    if(!file.exists(path_to_file)){
      ...
      for(i in seq_len(nrow(strata))){
        ...
        result[[paste0(strata$var[i],"_",strata$val[i])]]<-list(
          ...
          model = fit_mort_cov)
        #----------------------------------              
        print(paste0(adh,"...",boot_i,"...","stratified by:",
                     strata$var[i]," - ",strata$val[i]))
      }
      #----------------------------------
      print(paste0(adh,"...",boot_i,"...","stratified models collected"))
